...
(async function () {
     ...
     const uses = await Use.create([
          ...
          { name: 'leasehold improvments', sortOrder: 110 },
          { name: 'Licensing', sortOrder: 120 },
          { name: 'office supplies', sortOrder: 130 },
          { name: 'packaging', sortOrder: 140 },
          { name: 'purchases for resale', sortOrder: 150 },
          { name: 'QC/Lab', sortOrder: 160 },
     ]);
