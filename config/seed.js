...
(async function() {
  ...
  const payees = await Payee.create([
     { name: 'cmp', sortOrder: 10 },
     { name: 'A2Z', sortOrder: 20 },
     { name: 'AC moore', sortOrder: 30 },
     { name: 'Allen Sterling', sortOrder: 40 },
     { name: 'Allstar Health.', sortOrder: 50 },
     { name: 'Balance', sortOrder: 60 },
     { name: 'Broadway Gardens', sortOrder: 70 },
     { name: 'Bulk Apothecary', sortOrder: 80 },
     { name: 'Chemistrystore', sortOrder: 90 },
     { name: 'cmp', sortOrder: 100 },
     { name: 'CVS', sortOrder: 110 },
     { name: 'Dipietros', sortOrder: 120 },
     { name: 'Dishwaser-Uncle Andy', sortOrder: 130 },
     { name: 'dollar store', sortOrder: 140 },
     { name: 'Freeze Dryer', sortOrder: 150 },
     { name: 'Griffen Greenhouse', sortOrder: 160 },
     { name: 'Handsink-rest equiment store', sortOrder: 170 },
     { name: 'Heat system for grow room', sortOrder: 180 },
     { name: 'High Tech ', sortOrder: 190 },
     { name: 'home depo', sortOrder: 200 },
     { name: 'Home Depot', sortOrder: 210 },
     { name: 'Indendent power', sortOrder: 220 },
     { name: 'Jordan Farm', sortOrder: 230 },
     { name: 'labor cost-Rob Fogg', sortOrder: 240 },
     { name: 'Leapin Lizards', sortOrder: 250 },
     { name: 'Leroux Kitchen', sortOrder: 260 },
     { name: 'Lois', sortOrder: 270 },
     { name: 'lorann oils', sortOrder: 280 },
     { name: 'Mardens', sortOrder: 290 },
     { name: 'mountain Rose', sortOrder: 300 },
     { name: 'Multiple vendors', sortOrder: 310 },
     { name: 'Napa', sortOrder: 320 },
     { name: 'Natural Happiness', sortOrder: 330 },
     { name: 'Nolts Greenhouse', sortOrder: 340 },
     { name: 'oakhill', sortOrder: 350 },
     { name: 'Pharmaca', sortOrder: 360 },
     { name: 'Post office', sortOrder: 370 },
     { name: 'Proverda lab', sortOrder: 380 },
     { name: 'Renhui metal', sortOrder: 390 },
     { name: 'Sams Club', sortOrder: 400 },
     { name: 'shaws', sortOrder: 410 },
     { name: 'SJR Labs', sortOrder: 420 },
     { name: 'Staples', sortOrder: 430 },
     { name: 'State of Maine', sortOrder: 440 },
     { name: 'State of Mind', sortOrder: 450 },
     { name: 'true value', sortOrder: 460 },
     { name: 'Truffle made', sortOrder: 470 },
     { name: 'Uline', sortOrder: 480 },
     { name: 'Urban Garden', sortOrder: 490 },
     { name: 'Vessel Services', sortOrder: 500 },
     { name: 'walmrt', sortOrder: 510 },
     { name: 'zNatural', sortOrder: 520 },
  ]);
